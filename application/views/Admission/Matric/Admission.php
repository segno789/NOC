            ...
            <div class="span12">
                <div class="widget no-margin">
                    ...
                    <div class="widget-body">
                        <h1    style="text-align: center;"><font color="#000000" size="+1" >Note:-Last Date of Online Registartion for 9th  without late fee is <b class="blink_text"><?php echo lastdate; ?></b></font></h1>
                        ...
                        <div class="shortcutHome">
                            <a href="<?php echo base_url(); ?>index.php/Registration/NewEnrolment"><img src="<?php echo base_url();?>assets/img/enrolment.png"><br>Old Students</a>
                        </div>
                        <!--  <div class="shortcutHome">
                        <a href="GetInfo.php"><img src="<?php echo base_url();?>assets/img/enrolment.png"><br>Re-Admission</a>
                        </div>  -->    
                         <div class="shortcutHome">
                            <a href="<?php echo base_url(); ?>index.php/Registration/FormPrinting"><img src="<?php echo base_url();?>assets/img/reports.png"><br>Reports </a>
                        </div>
                        <div class="shortcutHome">
