                    ...
                    <div class="widget-body">
                        <div id="dt_example" class="example_alt_pagination">
                            <div class="info"  style="position:relative;margin:0;padding:0;overflow:hidden;">
                                <!--FORM START-->
                                <form enctype="multipart/form-data" id="ReturnStatus" name="ReturnStatus" method="post" action="<?php echo base_url(); ?>Consolidated_Corrections/getForm/<?php  echo @$info[0]['AppNo']; ?>" >
                            </div>
                            <label style="color: green; font-size: 32px;">Your Application is Submitted Successfully.</label>
                            <p>  <strong style=" font-size: 24px;"> Your Application No.<?php echo @$info[0]['AppNo']; ?> </strong></p>
...
<script type="text/javascript">
    ...
    var formno = '<?php echo @$info[0]['AppNo']; ?>';
