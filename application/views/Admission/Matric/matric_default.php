                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <form enctype="multipart/form-data" id="options" name="options" method="post" action="" >
                            <table>
                                <tr>
                                    <td ><label class="welcome_note myEngheading" >Exam Matric Annual, <?php
                                                     echo Year;
                                                 ?></label></td>
                                    <td><label class="myUrduheading">   امتحان میٹرک سالانہ <?php
                                                     echo Year;
                                                 ?></label></td>
                                </tr>
                                <tr>
                                    <td width="50%">
                                        <label class=myEngParagraph >  Note:-Last Date of Online Admissions and Submission of Hard Copy for Matric <?php if(Session == "1"){echo "Annual";} else echo "Supply" ?> Examination with (Single fee) is <?php echo lastdate ?>.</label>  
                                    </td>
                                    <td width="50%"  >
