...
<form action="" name="noc_form" id="noc_form" >
    ...
    <div class="form-group">    
        <div class="row">
            <div class="col-md-12">
                <h3 align="center" class="bold">1- Application for NO Objection Certificate</h3>
            </div>
        </div>
    </div>
...
<form enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>index.php/NOC/statusPage_server" >
    ...
    <div class="form-group">    
        <div class="row">
            <div class="col-md-12">
                <h3 align="center" class="bold">2- Check Status Section</h3>
            </div>
        </div>
    </div>
        ...
        <fieldset>
            <div class="form-group">
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <input type="text" class="form-control" value="<?php echo $info['app_No'];  ?>" readonly="readonly">    
                </div>
            </div>
